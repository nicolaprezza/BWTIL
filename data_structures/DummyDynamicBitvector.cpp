...
DummyDynamicBitvector::DummyDynamicBitvector(ulint n,size_t node_size) {
...
void DummyDynamicBitvector::insert(ulint i, bool x){
...
ulint DummyDynamicBitvector::rank(ulint i, bool x){
